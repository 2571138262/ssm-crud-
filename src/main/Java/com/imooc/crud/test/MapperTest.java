...
//        departmentMapper.insertSelective(new Department(null, "测试部"));
        ...
        // 2、生成员工数据，测试员工的插入
//        employeeMapper.insertSelective(new Employee(null, "Jerry", "M", "Jerry@imooc.com", 1));
        ...
        for (int i = 0; i < 1000; i ++){
            ...
            mapper.insertSelective(new Employee(null, uid, "M", uid + "@imooc.com", 1));
        }
        System.out.println("批量完成");

//        employeeMapper.insert(new Employee(null, "白晓文", "F", "baixiaowen@imooc.com", 2));
